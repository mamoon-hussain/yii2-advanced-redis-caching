                    ...
                    <div class="plan-header pt-3">
                        ...
                        <div class="plan-price">
                            <p class="price mbr-fonts-style m-0 display-1" style="direction: <?= $direction ?>"">
                                <strong><?= ($place->price*$model->price_unit_number).t('KD') ?> </strong>
                            </p>
                        </div>
                    </div>
                    <div class="plan-body">
                        <div class="plan-list mb-3">
                            ...
                            ?>">
                                <li class="list-group-item bg-transparent" style="padding: 5px 15px;direction: <?= $direction ?>; text-align: center;"">
                                    <?= t('From: ').date('M-d', strtotime($model->start_date))
                                    .' - '.t('For: ')
                                    .$model->price_unit_number  .' '. t('Days') ?>
                                </li>
                            </ul>
                        </div>
