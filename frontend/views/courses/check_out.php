                ...
                <div class="mbr-form form-with-styler">
                    <div class="dragArea row">
                        ...
                        <div class="col-12 col-md-auto mbr-section-btn">
                            <a href="<?= Yii::$app->urlManager->createUrl("/site/create-place-request?id=".$model->id) ?>" class="btn btn-secondary display-4"><?= t('Cash') ?></a>
                        </div>
                        <div class="col-12 col-md-auto mbr-section-btn">
                            <a href="<?= Yii::$app->urlManager->createUrl("/site/create-place-request?id=".$model->id) ?>" class="btn btn-secondary display-4"><?= t('PayPal') ?></a>
                        </div>
                    </div>
                </div>
            </div>
