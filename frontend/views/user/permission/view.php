...
$this->title = t('all', 'Settings for permission') . ': ' . $item->description;
$this->params['breadcrumbs'][] = ['label' => t('all', 'Permissions'), 'url' => ['index']];
...
<p>
	<?= GhostHtml::a(t('all', 'Edit'), ['update', 'id' => $item->name], ['class' => 'btn btn-sm btn-primary']) ?>
	...
	<div class="col-sm-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<strong>
					<span class="glyphicon glyphicon-th"></span> <?= t('all', 'Child permissions') ?>
				</strong>
			</div>
				...
				<strong>
					...
					<?= Html::a(
						...
						[
							...
							'data-confirm'=>t('all', 'Routes that are not exists in this application will be deleted. Do not recommended for application with "advanced" structure, because frontend and backend have they own set of routes.'),
						]
					) ?>
