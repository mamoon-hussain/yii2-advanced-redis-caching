...
$this->params['breadcrumbs'][] = ['label' => t('all', 'Users'), 'url' => ['/user/user/index']];
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                Html::checkboxList(
                        ...
                        $checkbox = "<div class='col-md-3'><label><input type='checkbox' name='{$name}' value='{$value}' {$isChecked}> {$label}</label></div>";
                ...
                <?php else: ?>
                    <div class="alert alert-warning well-sm text-center">
                        <?= t('all', 'You can not change own permissions') ?>
                    </div>
                <?php endif; ?>
