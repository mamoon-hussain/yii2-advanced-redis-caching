    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <p>
                ...
                <?= GhostHtml::a(t('all', 'Create'), ['create-admin'], ['class' => 'btn btn-sm btn-success']) ?>
                <?=
                GhostHtml::a(
                        t('all', 'Roles and permissions'), ['/user/user-permission/set', 'id' => $model->id], ['class' => 'btn btn-sm btn-default']
                )
                ?>
