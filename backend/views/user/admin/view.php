    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <p>
                ...
                <?= GhostHtml::a(t( 'Create'), ['create'], ['class' => 'btn btn-sm btn-success']) ?>
                <?=
                GhostHtml::a(
                        t( 'Roles and permissions'), ['/user/admin-permission/set', 'id' => $model->id], ['class' => 'btn btn-sm btn-default']
                )
                ?>

                <?= Html::a(t( 'Change Password'), ['change-password', 'id' => $model->id], ['class' => 'btn btn-sm btn-warning']) ?>
...
//                    'id',
                    [
                        'attribute' => 'status',
                        'value' => \common\models\Admin::getStatusValue($model->status),
                    ],
                    'fname',
                    'lname',
                    [
