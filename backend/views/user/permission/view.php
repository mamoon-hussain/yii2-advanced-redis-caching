...
$this->title =t( 'Settings for permission') . ': ' . $item->description;
$this->params['breadcrumbs'][] = ['label' =>t( 'Permissions'), 'url' => ['index']];
	...
	<div class="col-sm-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<strong>
					<span class="glyphicon glyphicon-th"></span> <?=t( 'Child permissions') ?>
				</strong>
			</div>
