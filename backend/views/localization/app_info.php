...
$this->title = \Yii::t('all', 'App Info Localization');
$this->params['breadcrumbs'][] = ['label' => Yii::t('all', 'App Info'), 'url' => ['view']];
                                ...
                                <div aria-labelledby="<?= $Lang ?>-tab" class="tab-pane fade <?= $active ?> show" id="<?= $Lang ?>"
                                    ...
                                    <div class="form-group">
                                        <?= $form->field($oneLangModel, 'description',
                                            ...
                                            'options' => [
                                                'rows' => 4,
                                                'name'=> $Lang.'_LocalizedAppInfo[description]',
                                                'id'=>$Lang.'-description',
                                            ],
                                            'language' => api_lang(),
                                    ...
                                    <div class="form-group">
                                        <?= $form->field($oneLangModel, 'home_description',
                                            [
                                                'selectors' => [
                                                    'input' => '#'.$Lang.'-home_description',
                                                    'container' => '#'.$Lang.'-container',
                                                ],
                                                'options' => ['id' => $Lang.'-container'],
                                            ])->widget(\dosamigos\tinymce\TinyMce::className(), [
                                            'options' => [
                                                'rows' => 4,
                                                'name'=> $Lang.'_LocalizedAppInfo[home_description]',
                                                'id'=>$Lang.'-home_description',
                                            ],
                                            'language' => api_lang(),
                                            'clientOptions' => tinymceClientOptions()
                                        ])->label(Yii::t('all', 'Home Description', [], $Lang));  ?>
                                    </div>
