...
$this->params['breadcrumbs'][] = ['label' => Yii::t('all', 'Places'), 'url' => ['index']];
                    ...
                    <div aria-labelledby="<?= $Lang ?>-tab" class="tab-pane fade <?= $active ?> show" id="<?= $Lang ?>"
                        ...
                        <div class="form-group">
                            <?= $form->field($oneLangModel, 'name',
                                ...
                                'name'=> $Lang.'_LocalizedPlace[name]',
                                'id'=>$Lang.'-name'])->label(Yii::t('all', 'Name', [], $Lang));  ?>
                        </div>

                        <?php if($itemModel->type == \common\enums\PlaceType::hall){ ?>
                            <div class="form-group">
                                <?= $form->field($oneLangModel, 'small_description',
                                    ...
                                    'rows' => '6',
                                    'name'=> $Lang.'_LocalizedPlace[small_description]',
                            ...
                            <div class="form-group">
                                <?= $form->field($oneLangModel, 'description',
                                    ...
                                    'options' => [
                                        'rows' => 4,
                                        'name'=> $Lang.'_LocalizedPlace[description]',
                                        'id'=>$Lang.'-description',
                                    ],
                                    'language' => api_lang(),
                        ...
                        <?php if($itemModel->placeContents){ ?>
                            <div class="form-group">
                                <div class="row" style="margin-bottom: 1%;">
                                    <div class="col-md-12">
                                        <label style="margin-bottom: 10px;"><?= Yii::t('all', 'Content', [], $Lang) ?></label>
                                        <div id="requirements">
                                            <?php
                                            foreach ($itemModel->placeContents as $rkey => $rone){
