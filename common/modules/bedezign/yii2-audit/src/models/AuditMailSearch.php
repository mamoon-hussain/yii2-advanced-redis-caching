...
class AuditMailSearch extends AuditMail
{
    ...
    public function rules()
    {
        ...
        return [
            [['id', 'entry_id', 'successful', 'to_name', 'from_name', 'reply', 'cc', 'bcc', 'subject', 'created'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'to_name', $this->to]);
        $query->andFilterWhere(['like', 'from_name', $this->from]);
