...
namespace common\modules\components;
...
class ExcelGridSave extends \yii\grid\GridView {
...
//        Yii::$app->end();
        ...
        //save on server
        $dir_file = Yii::getAlias('@backend' . '/..') . '/temp/' . $this->filename . '.' . $this->extension;
        file_put_contents($dir_file, '');
        unlink($dir_file);
        $writer->save($dir_file, $this->_objPHPExcelSheet);
//        Yii::$app->end();
//        return TRUE;
        parent::run();
