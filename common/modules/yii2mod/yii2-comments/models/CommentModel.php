...
class CommentModel extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['content', 'required', 'message' => Yii::t('subject', 'Comment cannot be blank.')],
            [['content', 'entity', 'entityId', 'parentId', 'relatedTo', 'url'], 'string'],
    ...
    {
        return $this->hasOne(\common\models\GlobalUser::className(), ['id' => 'createdBy']);
    }
    ...
    public function beforeSave($insert)
    {
        ...
        if (parent::beforeSave($insert)) {
            $this->createdBy = user()->guser_id;
            $this->updatedBy = user()->guser_id;
