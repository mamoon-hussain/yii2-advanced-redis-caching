    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <p>
                ...
                <?= GhostHtml::a(UserManagementModule::t('back', 'Create'), ['create-admin'], ['class' => 'btn btn-sm btn-success']) ?>
                <?=
                GhostHtml::a(
                        UserManagementModule::t('back', 'Roles and permissions'), ['/user-management/user-permission/set', 'id' => $model->id], ['class' => 'btn btn-sm btn-default']
                )
                ?>
